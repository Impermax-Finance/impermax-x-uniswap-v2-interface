...
export default function Risks() {
  return (<View>
    <Container className="article card">
      ...
      <p>If you’re new to Impermax and are unsure of how it works and how to use it, please check out our <a target="_blank" href="https://ropsten.impermax.finance/">application on the ropsten testnet</a> first. There, you will be able to use the same application and see how it interoperates with Uniswap in a safe environment with free funds.</p>
    </Container>
  </View>);
}